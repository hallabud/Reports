...
CREATE PROCEDURE [dbo].[usp_ssrs_ReportWorkVsRabotaActivityGroupsMonthly]
...
SELECT 
 ...
 , FullDate
 , FullDate104
 , CASE IsLegalPerson WHEN 1 THEN 0 WHEN 0 THEN 1 END
 , IsMegaChecked
 , HasPaidServices
 , IsActive6
 , IsActive3
 , IsActive2
 , CompaniesNum
FROM dbo.vw_CompaniesActivityGroupsMonthly
