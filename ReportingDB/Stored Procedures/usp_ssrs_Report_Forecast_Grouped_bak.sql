...
CREATE PROCEDURE [dbo].[usp_ssrs_Report_Forecast_Grouped_bak] (@StartDate DATETIME, @EndDate DATETIME)
...
FROM (
 ...
 JOIN SRV16.RabotaUA2.dbo.Manager M WITH (NOLOCK) ON AM.UserID = M.aspnet_UserUIN AND M.DepartmentID IN (2,3,4) AND M.IsForTesting = 0
