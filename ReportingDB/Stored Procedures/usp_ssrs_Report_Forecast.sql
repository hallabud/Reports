...
CREATE PROCEDURE [dbo].[usp_ssrs_Report_Forecast] (@StartDate DATETIME, @EndDate DATETIME)
...
--DECLARE @StartDate DATETIME; SET @StartDate = '2014-09-01';
--DECLARE @EndDate DATETIME; SET @EndDate = '2014-09-30';
