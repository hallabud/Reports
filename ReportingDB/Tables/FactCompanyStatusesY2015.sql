CREATE TABLE [dbo].[FactCompanyStatusesY2015] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2015] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(5480) AND [Date_key]<=(5844)),
    CONSTRAINT [FK_FactCompanyStatusesY2015_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2015]([VacancyDiffGroup] ASC)
