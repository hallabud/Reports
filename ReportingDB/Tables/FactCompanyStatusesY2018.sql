CREATE TABLE [dbo].[FactCompanyStatusesY2018] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2018] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(6576) AND [Date_key]<=(6940)),
    CONSTRAINT [FK_FactCompanyStatusesY2018_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2018]([VacancyDiffGroup] ASC)
