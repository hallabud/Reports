CREATE TABLE [dbo].[FactCompanyStatusesY2016] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2016] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(5845) AND [Date_key]<=(6210)),
    CONSTRAINT [FK_FactCompanyStatusesY2016_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2016]([VacancyDiffGroup] ASC)
