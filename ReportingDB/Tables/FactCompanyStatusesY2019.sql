CREATE TABLE [dbo].[FactCompanyStatusesY2019] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2019] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(6941) AND [Date_key]<=(7305)),
    CONSTRAINT [FK_FactCompanyStatusesY2019_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2019]([VacancyDiffGroup] ASC)
