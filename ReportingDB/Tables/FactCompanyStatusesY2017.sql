CREATE TABLE [dbo].[FactCompanyStatusesY2017] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2017] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(6211) AND [Date_key]<=(6575)),
    CONSTRAINT [FK_FactCompanyStatusesY2017_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2017]([VacancyDiffGroup] ASC)
