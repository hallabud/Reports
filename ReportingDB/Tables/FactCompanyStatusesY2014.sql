CREATE TABLE [dbo].[FactCompanyStatusesY2014] (
    ...
    CONSTRAINT [PK_FactCompanyStatusesY2014] PRIMARY KEY CLUSTERED ([Date_key] ASC, [Company_key] ASC),
    CHECK ([Date_key]>=(5115) AND [Date_key]<=(5479)),
    CONSTRAINT [FK_FactCompanyStatusesY2014_DimPaymentStatus] FOREIGN KEY ([PaymentStatusKey]) REFERENCES [dbo].[DimPaymentStatus] ([PaymentStatusKey])
);


GO
CREATE NONCLUSTERED INDEX [IX_VacancyDiffGroup]
    ON [dbo].[FactCompanyStatusesY2014]([VacancyDiffGroup] ASC)
